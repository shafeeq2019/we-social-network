                ...
                <div class="main-right col-span-1">
                    <div class="p-12 bg-white border border-gray-200 rounded-lg">
                        <form class="space-y-6">
                            <div>
                                <label>Name</label><br>
                                <input type="text" placeholder="Your e-mail address" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                            </div>
                            ...
                            <div>
                                <label>Repeate password</label><br>
                                <input type="password" placeholder="Repeate your password" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                            </div>
