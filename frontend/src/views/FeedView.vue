    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    <div class="p-4">
                        <textarea class="p-4 w-full bg-gray-100 rounded-lg"
                            placeholder="What are you thinking about?" v-model="body"></textarea>
                    </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg" v-for="post in posts" :key="post.id">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="https://i.pravatar.cc/300?img=57" class="w-[40px] rounded-full">

                        <p><strong>{{post.created_by.name}}</strong></p>
                    </div>

                    <p class="text-gray-600">{{post.created_ago}} ago</p>
                </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <div class="mb-3">
                    <p>This is a post with a photo</p>
                </div>
...
export default {
    ...
    methods: {
        ...
        async submitForm() {
            axios.post("/api/post/create/", { "body": this.body }).then(response => {
                this.body = '';
