    ...
    <div class="max-w-7xl mx-auto">
      <div class="flex items-center justify-between">
        ...
        <div class="menu-center flex space-x-12" v-if="userStore.user.isAuthenticated">
          ...
          <RouterLink
            :to="{ name: 'messages', params: { id: null } }"
        ...
        <template v-else>
          <div class="menu-right">
            <RouterLink
              class="py-2 px-4 bg-gray-500 text-white rounded-md mr-4 text-sm"
              to="/login"
              >Log in</RouterLink
            >
            <RouterLink
              class="py-2 px-4 bg-purple-600 text-white rounded-md text-sm"
              to="/signup"
              >Sign up</RouterLink
            >
          </div>
