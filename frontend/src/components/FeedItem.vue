        ...
        <div class="my-6 flex justify-between">
            <div class="flex space-x-6"> 
                <div class="flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" :fill="post.post_liked ? 'red' : 'none'" viewBox="0 0 24 24" stroke-width="1.5"
                        @click="likePost" :stroke="post.post_liked ? 'red' : 'currentColor'" class="w-6 h-6 cursor-pointer" >
